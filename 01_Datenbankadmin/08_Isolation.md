...
DROP TABLESPACE TBS_GRIESMAYER_ISOLATION INCLUDING CONTENTS AND DATAFILES;
DROP USER GRIESMAYER CASCADE;
DROP USER THOMAS CASCADE;

CREATE SMALLFILE TABLESPACE TBS_GRIESMAYER_ISOLATION
DATAFILE '/home/oracle/app/oracle/oradata/orcl/griesmayer_isolation1.dbf' SIZE 200M AUTOEXTEND ON NEXT 1M MAXSIZE UNLIMITED,
'/home/oracle/app/oracle/oradata/orcl/griesmayer_isolation2.dbf' SIZE 200M
LOGGING EXTENT MANAGEMENT LOCAL SEGMENT SPACE MANAGEMENT AUTO;

CREATE USER GRIESMAYER PROFILE "DEFAULT" IDENTIFIED BY "oracle"
DEFAULT TABLESPACE TBS_GRIESMAYER_ISOLATION
...
CREATE USER THOMAS PROFILE "DEFAULT" IDENTIFIED BY "oracle"
DEFAULT TABLESPACE TBS_GRIESMAYER_ISOLATION
TEMPORARY TABLESPACE TEMP
ACCOUNT UNLOCK;

GRANT SELECT ANY DICTIONARY TO THOMAS;
GRANT UNLIMITED TABLESPACE TO THOMAS;
